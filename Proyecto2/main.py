...
class Adriana:
    ...
    def __init__(self, ventana):
        ...
        menu_Ejecutar.add_command(label = '3D', command = self.ejecutar2P)
    ...
    def ejecutar2P(self):
        ...
        ENTORNO_RAIZ = EntornoTabla(Generador3DInstancia, None)
        ...
        self.txtSalida.insert(END,Generador3DInstancia.generarMain())
