    ...
    def obtenerValor(self, entorno):
        ...
        if self.tipo_operacion == TIPO_OPERACION.SUMA:
            ...
            if tipoResultante == TIPO_DATO.ENTERO:
                ...
                print(f"Error en la suma, no se puede operar: {retornoIzq.tipo} con {retornoDer.tipo}")
                return RetornoType()
            ...
            if self.unario:
                ...
                if tipoResultante == TIPO_DATO.ENTERO:
                    ...
                    print(f"Error en la resta, no se puede operar: {retornoIzq.tipo} con {retornoDer.tipo}")
                    return RetornoType()